...
ImportGitDatasetTask <- R6::R6Class("ImportGitDatasetTask", inherit = ProjectTask,
    public = list(url = NULL, version = NULL, gitToken = NULL, schemaId = NULL, initialize = function(json = NULL) {
        ...
        m = super$toTson()
        m$kind = tson.scalar("ImportGitDatasetTask")
