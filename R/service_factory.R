...
ServiceFactory <- R6::R6Class("ServiceFactory", public = list(issueMessageService = NULL, 
    ...
    issueService = NULL, subscriptionPlanService = NULL, persistentService = NULL, 
    activityService = NULL, folderService = NULL, tableSchemaService = NULL, taskService = NULL, 
    userSecretService = NULL, eventService = NULL, workflowService = NULL, userService = NULL, 
    projectDocumentService = NULL, cranLibraryService = NULL, teamService = NULL, 
