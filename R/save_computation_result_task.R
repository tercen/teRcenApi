...
#'
#' @export
#' @format \code{\link{R6Class}} object, super class \code{\link{ComputationTask}}, sub classes \code{\link{RunComputationTask}}.
...
SaveComputationResultTask <- R6::R6Class("SaveComputationResultTask", inherit = ComputationTask, 
